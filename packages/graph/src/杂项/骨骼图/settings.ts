/*
 * @Author: qinyadong
 * @Date: 2022-05-11 15:23:26
 * @LastEditors: qinyadong
 * @LastEditTime: 2022-05-12 14:43:04
 * @FilePath: \graph-model\src\杂项\骨骼图\settings.ts
 */
/*
 * @Author: qinyadong
 * @Date: 2022-05-11 17:04:41
 * @LastEditors: qinyadong
 * @LastEditTime: 2022-05-12 10:53:04
 * @FilePath: \aea-client\src\render\components\Skeleton\settings.ts
 */
...
export function getRGBForValue(value, MAX_VALUE) {
    ...
    return [palette[paletteIndex], palette[paletteIndex + 1], palette[paletteIndex + 2], palette[paletteIndex + 3] / 256];
}
