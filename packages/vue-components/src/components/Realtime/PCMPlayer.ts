/*
 * @Author: qinyadong
 * @Date: 2022-08-10 10:40:36
 * @LastEditors: qinyadong
 * @LastEditTime: 2022-08-10 10:40:37
 * @FilePath: \aea-client\packages\vue-components\src\components\Realtime\PCMPlayer.ts
 */
export default class PCMPlayer {
  ...
  getFormatedValue(data) {
    ...
    data = new TypedArray(data.buffer);
